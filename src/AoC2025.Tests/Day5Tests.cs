...
namespace AoC2025.Tests
{
	...
	public class Day5Tests
	{
		...
		public void Puzzle1_ExampleInput()
		{
			...
			Assert.That(Day5.Solve1(input), Is.EqualTo(3));
		}
		...
		{
			var input = InputReader.GetInputAsStringList("..\\..\\..\\PuzzleInputs\\day5_example2.txt");
			Assert.That(input.Count>0);
			Assert.That(Day5.Solve2(input), Is.EqualTo(14));
		}
